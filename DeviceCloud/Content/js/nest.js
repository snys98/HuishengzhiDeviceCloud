...
!function() {
    function g() {
        y.width = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth,
            y.height = window.innerHeight || document.documentElement.clientHeight || document.body.clientHeight;
    }
    ...
    function q() {
        ...
        j.forEach(function(t) {
            t.x += t.xa, t.y += t.ya, t.xa *= t.x > y.width || t.x < 0 ? -1 : 1, t.ya *= t.y > y.height || t.y < 0 ? -1 : 1,
                p.fillRect(t.x - 0.5, t.y - 0.5, 1, 1);
    ...
    window.onmousemove = function(a) {
        ...
        window.onmouseleave = function(a) {
            w.x = null, w.y = null;
        };
    //此处100为点数目
